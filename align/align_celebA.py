...
def main(args):
    ...
    for image_name in image_names:
        dataset.append(os.path.join(args.input_dir, image_name))
...
def parse_arguments(argv):
    ...
    parser.add_argument('--input-dir', type=str, help='Directory with unaligned images.',
        default='/media/lab225/Document2/merle/faceDataset/img_align_celeba')
    parser.add_argument('--output-dir', type=str, help='Directory with aligned face thumbnails.',
        default='/media/lab225/Document2/merle/faceDataset/celeba_align_112x96')
