...
# The defined prelu activation function
def prelu(x):
...
def resface_pre(lower_input, output_channels, padding='VALID', scope=None):
    net = pixelShuffler(lower_input, scale=2)
    net = slim.conv2d(net, output_channels, 3, padding=padding, scope=scope)
    return net
    ...
    with tf.variable_scope(scope, 'InceptionResnetV1', [inputs], reuse=reuse):
        with slim.arg_scope([slim.batch_norm, slim.dropout],
            ...
            with slim.arg_scope([slim.conv2d, slim.max_pool2d, slim.avg_pool2d],
                ...
                #                   scope='Conv2d_1a_3x3')
                net = resface_pre(inputs, 32, scope='Conv2d_1a_3x3')
                ...
                net = resface_pre(net, 64, scope='Conv2d_3a_3x3')
                ...
                #                   scope='Conv2d_4b_3x3')
                net = resface_pre(net, 256, scope='Conv2d_4b_3x3')
